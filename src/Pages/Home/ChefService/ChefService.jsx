    ...
    return ( 
        ...
        >
            <div className='md:py-10 bg-white mx-4 px-2 md:mx-20 md:px-10 lg:px-32 '>
                ...
                <p className='text-base text-center text-balance'>A restaurant is an establishment that prepares and serves food and drinks to customers.Meals are generally served and eaten on the premises, but many restaurants also offer take-out and food delivery services.</p>
            </div>
        </div>
    );
};
